...
To leave more or less room for the hole names on the left side (defaults to 34 characters, which is just enough room to accomodate the longest hole name while leaving a margin of 2 characters):
