...
To leave more or less room for the hole names on the left side (defaults to 33 columns, which is just enough room to accommodate the longest hole name while leaving a margin of 1 space to the left):
